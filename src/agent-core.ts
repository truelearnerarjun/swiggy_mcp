...
const TOOL_DESCRIPTIONS: Record<string, string> = {
  ...
  search_restaurants: "Search for restaurants by cuisine or query near a delivery address (takes addressId, query).",
  search_menu: "Search for specific dishes and food items across restaurants near a delivery address (takes addressId, query, vegFilter). Highly recommended for finding specific dishes, cravings, or protein items like paneer, soya, dal, rolls, etc.",
